(function (root, factory) {
  ...
  const gpus = [
    ...
    { id: 'a100-80', name: 'NVIDIA A100 80GB', memory_GB: 80,  bandwidth_GBps: 2039, fp16_TFLOPS: 312,   fp8_TFLOPS: null, fp32_TFLOPS: 19.5, sram_MB: 40,  note: 'Ampere, HBM2e' },
    { id: 'a100-40', name: 'NVIDIA A100 40GB', memory_GB: 40,  bandwidth_GBps: 1555, fp16_TFLOPS: 312,   fp8_TFLOPS: null, fp32_TFLOPS: 19.5, sram_MB: 40,  note: 'Ampere, HBM2' },
    ...
    { id: 'rtx3090', name: 'NVIDIA RTX 3090',  memory_GB: 24,  bandwidth_GBps: 936,  fp16_TFLOPS: 71,    fp8_TFLOPS: null, fp32_TFLOPS: 35.6, sram_MB: 6,   note: 'Ampere, GDDR6X' },
    { id: 't4',      name: 'NVIDIA T4',        memory_GB: 16,  bandwidth_GBps: 320,  fp16_TFLOPS: 65,    fp8_TFLOPS: null, fp32_TFLOPS: 8.1,  sram_MB: 4,   note: 'Turing, GDDR6' },
  ];
  ...
  return { models, gpus, precisions, kvPrecisions };
});
